...
/*
     ...
     PROD ARRAY CONTAINS THE ELEMENTS OF ALL PRODUCTIONS AS VOCAB_SYMBOLS,
     WHICH ARE INDICES INTO V, THE VOCABULARY. PROD_ARRAY_PTR POINTS TO
     THE LAST ENTRY USED IN PROD ARRAY.
     PROD START CONTAINS ONE ENTRY FOR EACH PRODUCTION, AND POINTS TO THE
     L.H.S. OF THE PRODUCTION.  PARALLEL ARRAY RHS LEN CONTAINS THE
